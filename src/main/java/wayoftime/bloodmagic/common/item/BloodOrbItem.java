...
public class BloodOrbItem extends Item {
    ...
    public int getCapacity(ItemStack stack) {
        return stack.getItemHolder().getData(BMDataMaps.BLOOD_ORBS).capacity();
    }

    public int getFillRate(ItemStack stack) {
        return stack.getItemHolder().getData(BMDataMaps.BLOOD_ORBS).fillRate();
    }

    public int getOrbTier(ItemStack stack) {
        return stack.getItemHolder().getData(BMDataMaps.BLOOD_ORBS).tier();
    }
}
